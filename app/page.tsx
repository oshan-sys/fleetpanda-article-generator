        ...
        if (msg.event === "meta") {
          ...
          if (data.truncated) {
            setTruncationWarning(
              `Heads up: the source document was very long, so only the first ${data.usedLength.toLocaleString()} of ${data.originalLength.toLocaleString()} characters were sent to Claude.`
            );
          }
